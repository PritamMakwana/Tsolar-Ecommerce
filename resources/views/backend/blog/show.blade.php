                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="">List Of All Blog</h2>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body" style="overflow-x: auto; max-width: 100%;">
                            <div>
                                <a href="{{ route('add-page-blog') }}" class="btn btn-primary">
                                    <i class="fa fa-plus"></i>
                                    <span style="font-family: 'Source Sans Pro', sans-serif;">Add Blog</span>
                                </a>
                            </div><br>
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td><img src="{{ asset('blogs_images/' . $d->image) }}" width="30" height="30">
                                        </td>
                                        <td>{{ $d->title }}</td>
                                        ...
                                        <td class=" text-center">
                                            <div class="action-buttons">
                                                <a href="{{ route('edit-page-blog',$d->id) }}" class="action-button"
                                                    style="margin-right: 10px;">
                                                    <i class="fa fa-edit"
                                                        style="font-size:20px;color:rgb(23, 239, 23)"></i>
                                                </a>
                                                <a href="{{ route('delete-blog',$d->id) }}" id="fdelete"
                                                    class="action-button">
