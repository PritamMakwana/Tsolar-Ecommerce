    ...
    <div class="d-flex flex-column m-4 m-md-5 p-2">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center p-3 mt-4">
            ...
            <div class="d-flex flex-wrap">
                ...
                <div class="border shadow-sm d-flex justify-content-center align-items-center p-2 me-1 rounded">
                    Items included : <span class="font">&nbsp01</span>
                </div>
            </div>
        </div>
        <div cla></div>
                            ...
                            <tbody>
                                <tr>
                                    <td class="centered-text"><img
                                            src="{{ asset('Product_thumbnails/' . $cart->products->image) }}"
                                            alt="Product Image" width="100"></td>
                                    <td class="centered-text">{{ $cart->products->product_name }}</td>
                                    <td class="centered-text">{{ $cart->quantity }}</td>
                                    <td class="centered-text">{{ $cart->total }}</td>
                                    <td class="centered-text">{{ $cart->products->specification }}</td>
                                    {{-- <td class="centered-text"><button
                                            onclick="window.open('{{ route('product', $cart->products->product_id) }}');"
                                    ...
                                    <td class="centered-text">
                                        <div class="d-flex justify-content-center">
                                            <button class="custom-btn px-4 py-1 d-flex align-items-center"
                                                onclick="window.open('{{ route('product', $cart->products->product_id) }}');">
                                                <div class="d-flex  align-items-center" style="background-color:#4DEAFF;">
            ...
            <!-- Add more rows as needed -->
                    ...
                    <div class="d-block d-md-none">
                        <table class="table">
                            ...
                            <tr>
                                <th>Product Image</th>
                                <td><img src="{{ asset('Product_thumbnails/' . $cart->products->image) }}"
                                        alt="Product Image" width="100"></td>
                            </tr>
                            <tr>
                                <th>QTY</th>
                            ...
                            <tr>
                                ...
                                <td>{{ $cart->products->specification }}</td>
                            </tr>
                            <tr>
                                <th>Action</th>
                                <td><button onclick="window.open('{{ route('product', $cart->products->product_id) }}');"
